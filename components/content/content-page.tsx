      ...
      <div className="flex flex-wrap gap-2 mb-10">
        {categories.map((category) => (
          <Button
            ...
            className={activeCategory === category.id ? "bg-outlive-green-400 hover:bg-outlive-green-500" : ""}
          >
            {category.name}
          </Button>
        ))}
        ...
        <div className="mb-12">
          ...
          <div className="grid gap-6 md:grid-cols-3">
            {featuredContent.map((content) => (
              <Link key={content.id} href={`/content/blog/${content.id}`} className="block h-full">
