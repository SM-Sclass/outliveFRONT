...
const blogPosts = [
  ...
  },
  {
    ...
    image: "/placeholder.svg?height=200&width=400&query=sleep%20science",
  },
  {
    id: "5",
    ...
    image: "/placeholder.svg?height=200&width=400&query=nutrition%20facts",
  },
  {
    id: "6",
    ...
    image: "/placeholder.svg?height=200&width=400&query=healthy%20habits",
  },
]
  ...
  return (
    <div className="container mx-auto px-4 py-8 space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {blogPosts.map((post) => (
          <Link key={post.id} href={`/content/blog/${post.id}`} className="block h-full">
